    ...
    class StressTest
    {
        ...
        */
                                ...
                                double location_accum_up, double location_accum_down)
        {
            ...
            Cell cellItem_max = null;
			Cell cellItem_up = null;
			Cell cellItem_down = null;
			Cell cellItem_location = null;
			Cell cellItem_location_up = null;
			Cell cellItem_location_down = null;
			Cell cellItem_accum_up = null;
			Cell cellItem_accum_down = null;
			Cell cellItem_location_accum_up = null;
			Cell cellItem_location_accum_down = null;
            ...
            if (way.Equals("皮带顺槽") && deep == 7) {
                ...
                cellItem_max = workSheet_excel.Cells["D3"];
                cellItem_up = workSheet_excel.Cells["F3"];
                cellItem_down = workSheet_excel.Cells["H3"];
                cellItem_location = workSheet_excel.Cells["E3"];
                cellItem_location_up = workSheet_excel.Cells["G3"];
                cellItem_location_down = workSheet_excel.Cells["I3"];
                cellItem_accum_up = workSheet_excel.Cells["J3"];
                cellItem_accum_down = workSheet_excel.Cells["L3"];
                cellItem_location_accum_up = workSheet_excel.Cells["K3"];
                cellItem_location_accum_down = workSheet_excel.Cells["M3"];
            ...
            else if (way.Equals("皮带顺槽") && deep == 12)
            {
                ...
                cellItem_max = workSheet_excel.Cells["D4"];
                cellItem_up = workSheet_excel.Cells["F4"];
                cellItem_down = workSheet_excel.Cells["H4"];
                cellItem_location = workSheet_excel.Cells["E4"];
                cellItem_location_up = workSheet_excel.Cells["G4"];
                cellItem_location_down = workSheet_excel.Cells["I4"];

                cellItem_accum_up = workSheet_excel.Cells["J4"];
                cellItem_accum_down = workSheet_excel.Cells["L4"];
                cellItem_location_accum_up = workSheet_excel.Cells["K4"];
                cellItem_location_accum_down = workSheet_excel.Cells["M4"];
            }
            else if (way.Equals("轨道巷") && deep == 7)
            {

                cellItem_max = workSheet_excel.Cells["D5"];
                cellItem_up = workSheet_excel.Cells["F5"];
                cellItem_down = workSheet_excel.Cells["H5"];
                cellItem_location = workSheet_excel.Cells["E5"];
                cellItem_location_up = workSheet_excel.Cells["G5"];
                cellItem_location_down = workSheet_excel.Cells["I5"];

                cellItem_accum_up = workSheet_excel.Cells["J5"];
                cellItem_accum_down = workSheet_excel.Cells["L5"];
                cellItem_location_accum_up = workSheet_excel.Cells["K5"];
                cellItem_location_accum_down = workSheet_excel.Cells["M5"];
            }
            else if (way.Equals("轨道巷") && deep == 12)
            {

                cellItem_max = workSheet_excel.Cells["D6"];
                cellItem_up = workSheet_excel.Cells["F6"];
                cellItem_down = workSheet_excel.Cells["H6"];
                cellItem_location = workSheet_excel.Cells["E6"];
                cellItem_location_up = workSheet_excel.Cells["G6"];
                cellItem_location_down = workSheet_excel.Cells["I6"];

                cellItem_accum_up = workSheet_excel.Cells["J6"];
                cellItem_accum_down = workSheet_excel.Cells["L6"];
                cellItem_location_accum_up = workSheet_excel.Cells["K6"];
                cellItem_location_accum_down = workSheet_excel.Cells["M6"];
            }


				cellItem_max.PutValue(Math.Round(max, 2));
                cellItem_location.PutValue(location);

                if(up != 0)
                    cellItem_up.PutValue(Math.Round(up, 2));
                if(down != 0)
                    cellItem_down.PutValue(Math.Abs(Math.Round(down, 2)));
                if (location_down != 0)
                ...
                if (accum_up != 0) {
                    cellItem_accum_up.PutValue(Math.Round(accum_up, 2));
                }
                if (accum_down != 0) {
                    cellItem_accum_down.PutValue(Math.Abs(Math.Round(accum_down, 2)));
                }
